  ...
  const steps = [
    {
      ...
      description:
        "Client call ends or WhatsApp thread wraps. Open MintAgree — the conversation is already there.",
      icon: (
    ...
    },
    {
      ...
      title: "Receipt sent",
      description:
        "Fill scope, deliverables, budget, due dates. Hit send. Delivered by email or WhatsApp — your choice. 90 seconds.",
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    ...
    },
    {
      ...
      title: "Client signs",
      description:
        "They get a link over email or WhatsApp. Enter the one-time code. Done — binding acknowledgment. Project aligned.",
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
